...
Route::group(['prefix' => 'menu'], function(){
	...
	Route::get('edit/{id}', 'MenuController@getEdit')->name('menu.getEdit');

	Route::post('edit/menu', 'MenuController@postEdit')->name('menu.postEdit');

	Route::post('drag', 'MenuController@drag')->name('menu.drag');

	Route::get('delete/{id}', 'MenuController@deleteMenu');
});
